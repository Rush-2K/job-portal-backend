...
public class BookmarkController {
    ...
    @GetMapping("/view")
    public ResponseEntity<?> viewListOfBookmark() {
        List<ViewBookmarkJobResponseDTO> responses = bookmarkService.view();

        return ResponseEntity.status(HttpStatus.OK).body(new ApiResponseDto<>(ApiStatus.SUCCESS, HttpStatus.OK.value(),
                "Successfully retrieved", LocalDateTime.now(), responses));
    }
